...
- (void)loginSuccess:(BOOL)isLogin {
    ...
    NSArray *array=[NSArray arrayWithObjects:@"诊断预约",@"主任医师",@"医院资源",@"个人中心", nil];
    
    
    // 添加子控制器
    [self addChildViewControllerWithTitle:[array objectAtIndex:0]//NSLocalizedString(@"menu_1", nil)
                           storyboardName:@"AppointDoctor"
                                     icon:@"product_gray"
                                  selIcon:@"product_gray"];
    
    [self addChildViewControllerWithTitle:[array objectAtIndex:1]//NSLocalizedString(@"menu_2", nil)
    ...
    if (isLogin) { //登陆成功
        ...
        [self addChildViewControllerWithTitle:[array objectAtIndex:3]//NSLocalizedString(@"menu_4", nil)
